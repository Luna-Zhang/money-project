...
import com.make.money.data.service.CustomerBandInfoService;
 ...
 */
@RestController
@RequestMapping("/customerBandInfo")
@Api(tags = "多客绑定信息表")
public class CustomerBandInfoController {

    @Resource
    private CustomerBandInfoService service;
    ...
    public HttpResponse add(@RequestBody CustomerBandInfo entity) {
        service.add(entity);
    ...
    public HttpResponse edit(@RequestBody CustomerBandInfo entity) {
        service.edit(entity);
        return HttpResponse.ok();
    }
    ...
    public HttpResponse get(@RequestBody CustomerBandInfo entity) {
