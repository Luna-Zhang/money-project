...
import com.make.money.data.service.RolePermissionInfoService;
 ...
 */
@RestController
@RequestMapping("/rolePermissionInfo")
@Api(tags = "角色权限关联表")
public class RolePermissionInfoController {

    @Resource
    private RolePermissionInfoService service;
    ...
    public HttpResponse add(@RequestBody RolePermissionInfo entity) {
        service.add(entity);
    ...
    public HttpResponse edit(@RequestBody RolePermissionInfo entity) {
        service.edit(entity);
        return HttpResponse.ok();
    }
    ...
    public HttpResponse get(@RequestBody RolePermissionInfo entity) {
