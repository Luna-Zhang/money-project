...
import com.make.money.data.service.BaseDictItemService;
...
@Api(tags = "基础字典表")
public class BaseDictItemController {

    @Resource
    private BaseDictItemService service;
    ...
    public HttpResponse add(@RequestBody BaseDictItem entity) {
        service.add(entity);
    ...
    public HttpResponse edit(@RequestBody BaseDictItem entity) {
        service.edit(entity);
        return HttpResponse.ok();
    }
    ...
    public HttpResponse get(@RequestBody BaseDictItem entity) {
